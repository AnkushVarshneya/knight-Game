...
public class Search {
	...
	public static Node AStarSearch(Model problem, GameTypeEnum gametype){
		...
		while (!fringe.isEmpty()){
			...
			if(!closelist.contains(currentNode)){				
				...
				// Now expand
				LinkedList<Node> expandedChildren = expandNode(problem, currentNode);
	...
	public static Node bfsSearch(Model problem){
		...
		while (!fringe.isEmpty()){
			...
			if(!closelist.contains(node)){				
				...
				// Now expand
				LinkedList<Node> expandedChildren = expandNode(problem, node);
				// process the children
				while(!expandedChildren.isEmpty()) {
	 ...
	 */
	private static LinkedList<Node> expandNode(Model problem, Node node) {
